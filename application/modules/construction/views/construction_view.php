    ...
    <body>
        <div class="main_container">
            ...
            <form id="subscribe_form" class="email" action="<?php echo site_url('ajax/email_ajax/submit'); ?>" rel="async" method="post">
                <input class="field" autocomplete="off" name="subscribe_email" placeholder="<?php echo lang('static_content_home_subscribe_header') . ' - ' . lang('static_content_home_email'); ?>" type="text" />
